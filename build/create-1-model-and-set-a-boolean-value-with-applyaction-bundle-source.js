...
import { applyAction, types } from "mobx-state-tree";
...
suite.add("Create 1 model and set a boolean value with applyAction", () => {
...
const m = ModelWithPrimitivesAndActions.create({
  string: "string",
  number: 1,
  integer: 1,
  float: 1.1,
...
applyAction(m, {
  ...
  trackMaxMemory("Create 1 model and set a boolean value with applyAction", memoryUsed);
});
